    ...
    <form action="{{ route('filtrarCampeonatosPainel') }}" method="POST" class="bg-custom rounded col-12 py-3 px-4">
        ...
        <div class="row align-items-end row-gap-4">
            ...
            <div class="col-3 d-flex flex-wrap">
                ...
                <div class="col-12">
                    <select name="status" class="form-control bg-dark text-light border-dark form-select" id="status" name="status">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="{{ route('editarCampeonato', $campeonato->id) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
