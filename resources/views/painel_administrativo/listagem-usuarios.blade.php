    ...
    <form action="{{ route('filtrarUsuarios') }}" method="POST" class="bg-custom rounded col-12 py-3 px-4">
        ...
        <div class="row align-items-end row-gap-4">
            <div class="col-3 d-flex flex-wrap">
                ...
                <div class="col-12">
                    <input type="text" class="form-control bg-dark text-light border-dark" id="search" name="busca" placeholder="Ex: Admin">
                </div>
            </div>
            ...
            <div class="col-3 d-flex flex-wrap">
                ...
                <div class="col-12">
                    <select name="status" class="form-control bg-dark text-light border-dark form-select" name="status" id="status">
...
<div class="bg-custom rounded overflow-hidden">
    <table class="table mb-0 table-custom table-dark align-middle">
        <thead>
            <tr>
                <th scope="col" class="text-uppercase">Admin</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="{{ route('editarUsuario', $usuario->id) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
...
<nav aria-label="navigation">
    ...
    @if (isset($filtros))
        {{ $usuarios->appends($filtros)->links('vendor.pagination.bootstrap-5') }}
    @else
