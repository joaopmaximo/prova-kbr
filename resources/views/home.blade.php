...
@section('conteudo')
    <main>
      ...
      <section aria-labelledby="destaques_titulo" class="py-12">
        ...
        <div
          class="max-w-7xl mx-2 lg:mx-auto mt-6 flex flex-wrap gap-4"
        >
        @foreach ($destaques as $destaque)
          ...
          >
            ...
            >
              <img
                src="{{ asset('imgs/' . $destaque->imagem) }}"
              ...
              <div class="p-3 relative">
                ...
                >
                  <p class="text-2xl font-bold" data-calendar>{{ date('d', strtotime($destaque->data_realizacao)) }}</p>
                  <p>{{ $mes[date('M', strtotime($destaque->data_realizacao))] }}</p>
                </div>
                <p
                ...
                <p class="text-gray-400 flex gap-2 my-2">
                  ...
                  {{ $destaque->cidade . ", " . $destaque->estado }}
                </p>
              </div>
              <a
                href="{{ route('integra', ['id' => $destaque->id, 'titulo_campeonato' => Str::slug($destaque->titulo_campeonato)]) }}"
